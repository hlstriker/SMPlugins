...
new const String:PLUGIN_NAME[] = "Style: Low FOV";
new const String:PLUGIN_VERSION[] = "1.1";

public Plugin:myinfo =
{
	name = PLUGIN_NAME,
	author = "Hymns For Disco(Edited by: Smiley)",
	description = "Style: Low FOV",
	version = PLUGIN_VERSION,
	url = "www.swoobles.com"
}

#define THIS_STYLE_BIT			STYLE_BIT_LOW_FOV
#define THIS_STYLE_NAME			"Low FOV"
#define THIS_STYLE_NAME_AUTO	"Low FOV + Auto Bhop"
...
{
	CreateConVar("style_low_fov_ver", PLUGIN_VERSION, PLUGIN_NAME, FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_PRINTABLEONLY);
	
	cvar_add_autobhop = CreateConVar("style_lowfov_add_autobhop", "0", "Add an additional auto-bhop style for this style too.", _, true, 0.0, true, 1.0);
	cvar_force_autobhop = CreateConVar("style_lowfov_force_autobhop", "0", "Force auto-bhop on this style.", _, true, 0.0, true, 1.0);
	
	cvar_fov = CreateConVar("style_lowfov_fov", "35", "The low FOV value to use", _, true, 0.0, true, 90.0);
}
...
public MovementStyles_OnRegisterReady()
{
	...
	MovementStyles_RegisterStyleCommand(THIS_STYLE_BIT, "sm_lowfov");
	MovementStyles_RegisterStyleCommand(THIS_STYLE_BIT, "sm_lofov");
}
