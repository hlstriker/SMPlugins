...
public EntityHooker_OnRegisterReady()
{
	...
	EntityHooker_RegisterAdditional(EH_TYPE_REMOVE_ENTITIES,
		"prop_detail", "prop_door_rotating", "prop_dynamic", "prop_dynamic_override", "prop_physics", "prop_physics_multiplayer", "prop_physics_override", "prop_ragdoll", "prop_static");
