...
new const String:PLUGIN_NAME[] = "[UltJB] Effect: Speed";
...
{
	CreateConVar("ultjb_effect_speed_ver", PLUGIN_VERSION, PLUGIN_NAME, FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_NOTIFY|FCVAR_PRINTABLEONLY);
}
